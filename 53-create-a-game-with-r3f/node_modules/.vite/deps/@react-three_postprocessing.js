...
import {
  easing
} from "./chunk-7JLALOMT.js";
import {
  FullScreenQuad,
  isWebGL2Available
} from "./chunk-RLYMHWMO.js";
import {
  applyProps,
  createPortal,
  extend,
...
var N8AO = (0, import_react.forwardRef)(
  ({
    ...
    }, [screenSpaceRadius, color2, aoRadius, distanceFalloff, intensity, aoSamples, denoiseSamples, denoiseRadius]);
    (0, import_react.useLayoutEffect)(() => {
      if (quality)
